  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-background px-4 py-10 text-foreground">
      <section className={cn("w-full max-w-[420px]", className)}>
        <div className="mb-7">
          <span className="grid size-11 place-items-center rounded-xl border border-border/20 bg-secondary text-foreground">
        ...
        <div className="rounded-2xl border border-border/20 bg-secondary p-5 shadow-xl shadow-black/10 sm:p-6">{children}</div>
      </section>
    </main>
  );
}
