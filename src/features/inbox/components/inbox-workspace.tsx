...
export function InboxWorkspace({ initialData, developmentPreview = false }: { initialData: InboxPageData; developmentPreview?: boolean }) {
  ...
  return <div className="px-4 py-4 sm:px-5 lg:px-6 lg:py-5">
    ...
    {developmentPreview ? <p className="mt-4 rounded-lg border border-white/[0.065] bg-white/[0.025] px-3 py-2 text-xs text-muted-foreground">Preview mode does not persist Inbox items. Configure Supabase to use the manual Inbox workflow.</p> : null}
